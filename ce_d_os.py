...
root = Tk()
root.title("CE-D (Operating System)")
...
def submit_attendance():
    ...
    for i, attendance_gui in enumerate(records):
        sEnroll, sName, sRoll = attendance_gui
        query = "INSERT INTO ce_d_os (date, sEnroll, sName, sRoll, status) VALUES (%s, %s, %s, %s, %s)"
